    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">
              La plataforma líder que conecta marcas con creadores de contenido auténticos.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="#creators" className="hover:text-white transition-colors">Creadores</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} UGCreators. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
